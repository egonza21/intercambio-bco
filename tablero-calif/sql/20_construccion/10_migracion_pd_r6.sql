-- ============================================================================
-- CONSTRUCCIÓN: proceso.migracion_pd_r6
-- ----------------------------------------------------------------------------
...
drop table if exists proceso.migracion_pd_r6 purge;

create table proceso.migracion_pd_r6
stored as parquet
as
with series as (
...
origen as (
  select
    ...
    d.idx_mes + 6 as idx_mes_destino,
    d.modelo, d.decil
  from deciles d
),
...
compute stats proceso.migracion_pd_r6;
