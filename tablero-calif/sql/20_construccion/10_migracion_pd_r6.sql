...
--
--   tmp_migracion_pd_r6_deciles  el ntile, materializado UNA vez
--   tmp_migracion_pd_r6_base     presencia del cliente por mes
--   tmp_migracion_pd_r6_par      el full outer join
--
