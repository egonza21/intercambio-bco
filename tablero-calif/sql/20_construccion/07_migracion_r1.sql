...
--
--   tmp_migracion_r1_origen     el lado origen, con el mes ya desplazado
--   tmp_migracion_r1_destino    el lado destino
--   tmp_migracion_r1_base       presencia del cliente por mes
--   tmp_migracion_r1_par        el resultado del full outer join
--
...
--
-- Los primeros 1 mes no tienen mes de origen, así que no producen
